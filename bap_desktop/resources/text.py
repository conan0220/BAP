...
UPDATE_HANDOFF = "更新已下載，正在交給獨立 Updater…"
UPDATE_INSTALLING = "Updater 已接手。BAP 正在安全關閉，完成後會自動開啟新版。"
UPDATE_FAILED = "更新失敗，現有版本不受影響。請稍後再試。"
UPDATE_RECOVERED = "新版未能正常啟動，系統已恢復上一個可用版本。"
UPDATE_MANUAL_REPAIR = "自動恢復失敗。程式檔與診斷紀錄已保留，請依提示手動啟動可用版本。"
